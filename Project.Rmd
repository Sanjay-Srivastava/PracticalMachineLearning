...
### Analysis Goal 
Create a Prediction Algorithm that takes a set of sensor readings and predicts the corresponding class.
...
3. The accuracy diminishes significantly when we use the LDA classifiers. As many as 3 out of 20 predictions were inconsistent. We will therefore, ignore this model.  
